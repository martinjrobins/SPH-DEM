...
const double INLET_FLOW_RATE = 400.0;
...
const double ALPHA_ARTIFICIAL = 0.5;
//#define HANN
...
const int MAX_NUM_PARTICLES_PER_CPU = 4.0*NX*NY*CYLINDER_HEIGHT/PSEP + 1.0*NDEM + 2.0*DEM_DISK_NDEM;
const int MAX_NUM_DEM_PARTICLES = 1.0*NDEM + 2.0*DEM_DISK_NDEM;
const double LIQ_DEM_COUPLING_RADIUS = 2.999*H;
